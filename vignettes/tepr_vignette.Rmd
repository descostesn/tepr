...
The function `meandifference` computes two types of statistics, the mean values of scores and the ecdf for each replicate (if provided) and difference of mean ecdf with the uniform cumulative distribution respectively. The mean values between !!!!!!!!
