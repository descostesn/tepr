...
```{r quickstartonepartone, results = 'hide', message = FALSE, warning = FALSE}
...
```{r quickstartoneparttwo, results = 'hide', message = FALSE, warning = FALSE}
...
```{r quickstarttwo, results = 'hide', message = FALSE, warning = FALSE}
#########
