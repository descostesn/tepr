...
## Parameters
message("AAAAAAAAA - Parameters preprocessing\n")
expprepath <- system.file("extdata", "exptab-preprocessing.csv", package="tepr")
windsize <- 200

## Read input tables
message("AAAAAAAAA - Read input tables preprocessing \n")
expdfpre <- read.csv(expprepath)

## Retrieving the bedgraph paths
message("AAAAAAAAA - Retrieving the bedgraph paths\n")
...
message("AAAAAAAAA - Reading gencode etc\n")
...
message("AAAAAAAAA - Calling preprocessing")
...
message("AAAAAAAAA - Parameters tepr\n")
exppath <-  system.file("extdata", "exptab.csv", package="tepr")
transpath <- system.file("extdata", "cugusi_6.tsv", package="tepr")
expthres <- 0.1

## Read input tables
message("AAAAAAAAA - Read input tables for tepr\n")
expdf <- read.csv(exppath)
transdf <- read.delim(transpath, header = FALSE)

message("AAAAAAAAA - Calling tepr\n")
...
<img src="pictures/structure.png" alt="structure"/>
...
blacklisthighmap(maptrackpath, blacklistpath, expprepath, nbcputrans = 1, allwindowsbed, windsize, genomename = "hg38", tmpfold = file.path(getwd(), "tmptepr"))
```
...
finaltab <- createtablescores(tmpfold = file.path(getwd(), "tmptepr"), expprepath, savefinaltable = FALSE)
```
