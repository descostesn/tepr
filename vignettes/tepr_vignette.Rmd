...
## Retrieving chromosome information (optional)
chrominfo <- rtracklayer::SeqinfoForUCSCGenome(genomename)

blacklisthighmap(maptrackpath, blacklistshpath, exptabpath, nbcputrans, allwindowsbed, windsize, chromtab = chrominfo, tmpfold = tmpfolder, showtime = TRUE)
```
