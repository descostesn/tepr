...
## Note on processing the complete datset

Note that parallelization is encouraged on the complete dataset. We used 20 cpus. The code below assumes that the files "dTAG_Cugusi_stranded_20230810.tsv" and "exptab.csv" are in the current folder. The composition of the experiment table is indicated in the next section.
