...
- `resmeandiff_<comparison>`: Results from the `meandifference` function for the specific comparison.
- `resunigroupatt_<comparison>`: Results from the `universegroup` function for the specific comparison. 
