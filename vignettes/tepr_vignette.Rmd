...
#########
# Pre-processing - takes ~ 47 seconds
#########

## Parameters
exppath <-  system.file("extdata", "exptab-preprocessing.csv", package="tepr")
...
exppath <- "./exptab-preprocessing.csv"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
exppath <-  system.file("extdata", "exptab.csv", package="tepr")
transpath <- "/g/romebioinfo/tmp/preprocessing/objects-tsv-7cpus/cugusi.tsv"
genevec <- c("ENST00000275493.7", "ENST00000230895.11", "ENST00000527786.7",
"ENST00000274140.10", "ENST00000549802.5", "ENST00000615891.2")
reslist <- lapply(genesvec, function(currentgene, transdf){
    return(transdf[which(transdf$V5)])
}, transdf)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
blacklistpath <- system.file("extdata", "hg38-blacklist-chr13.v2.bed", package = "tepr")
nbcputrans <- 1
genomename <- "hg38"
tmpfolder <- "./tmp"
...
blacklisthighmap(maptrackpath, blacklistpath, exptabpath, nbcputrans, allwindowsbed, windsize, genomename, tmpfold = tmpfolder)
```
