...
test_that("Errors are thrown when calling averageandfilterexprs", {
    ...
    expm <- "\n\nThe table of values \\(alldf\\) and the table of experiment information \\(expdf\\) do not correspond. The first four columns of expdf should be:\n\n \\-\\- condition:ctrl ctrl ctrl ctrl HS HS HS HS\n\n \\-\\- replicate: 1 1 2 2 1 1 2 2\n\n \\-\\- direction: forward reverse forward reverse forward reverse forward reverse\n\n \\-\\- strand: plus minus plus minus plus minus plus minus\n\n Also make sure that the bedgraph paths are correct.\n\n"
