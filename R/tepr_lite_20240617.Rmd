...
# .libPaths(c("/opt/homebrew/Cellar/r/4.2.1_2/lib/R/library", .libPaths()))
library("multimode") # to test modality
library("ggplot2")
library("moments") # to test skewness
# conda Densities contains bedtools bedops mosdepth ucsc-bigwigtobedgraph
library("tidyverse")
library("inflection") # to find inflection point in a curve
library("ggside")
library("tidyverse")
library("tidyquant")
library("ggpubr")
